# Generated by Django 3.0.5 on 2020-10-08 17:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='Название')),
                ('year', models.PositiveIntegerField(db_index=True, validators=[api.models.validate_date_not_in_future])),
                ...
                ('genre', models.ManyToManyField(blank=True, related_name='titles', related_query_name='query_titles', to='api.Genre', verbose_name='Жанр')),
            ],
            options={
